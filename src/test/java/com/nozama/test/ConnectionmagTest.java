...
import java.net.URL;
public class ConnectionmagTest {
...
//    vars = new HashMap<String, Object>();
  ...
  @Test
  public void connectionmag() {
    driver.get("http://127.0.0.1/nozama/");
    driver.manage().window().setSize(new Dimension(746, 821));
    {
      List<WebElement> elements = driver.findElements(By.cssSelector("#block-user-0 .title"));
    ...
    {
      List<WebElement> elements = driver.findElements(By.linkText("Liste des produits"));
      assert(elements.size() > 0);
    }
    driver.findElement(By.linkText("Liste des produits")).click();
    {
      List<WebElement> elements = driver.findElements(By.linkText("cafetiere"));
      assert(elements.size() > 0);
    }
    driver.findElement(By.linkText("cafetiere")).click();
    {
