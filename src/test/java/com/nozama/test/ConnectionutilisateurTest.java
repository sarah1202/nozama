...
import java.net.URL;
public class ConnectionutilisateurTest {
  ...
  public void connectionutilisateur() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.linkText("Mon compte"));
      assert(elements.size() > 0);
    }
    driver.findElement(By.linkText("Mon compte")).click();
    {
      List<WebElement> elements = driver.findElements(By.linkText("Cliquez ici pour voir l\'historique de vos commandes."));
      assert(elements.size() > 0);
    }
    driver.findElement(By.linkText("Cliquez ici pour voir l\'historique de vos commandes.")).click();
    {
